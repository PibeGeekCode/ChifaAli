...
### Modificar el menú
Edita `menu.html` y agrega nuevos items con la estructura:

```html
<div class="menu-item" data-id="ID" data-name="Nombre" data-price="PRECIO">
  <img src="URL_IMAGEN" alt="Nombre">
  <h4>Nombre del Plato</h4>
  <p>Descripción</p>
  <span class="price">S/ PRECIO</span>
  <button class="btn btn-small add-to-reservation" data-id="ID">Agregar a reserva</button>
</div>
```

### Modificar mesas
Edita el array `TABLES` en `js/reservations.js` y `js/admin.js`

### Cambiar credenciales admin
Edita `ADMIN_CREDENTIALS` en `js/admin.js`
...
3. Ve a Settings → Pages → Deploy from main branch
4. Tu sitio estará en: `https://tuusuario.github.io/chifaali/`

### Netlify
1. Arrastra la carpeta `chifaali_clone` a netlify.com
...
Para dudas o consultas, contacta a: contacto@chifaali.com
